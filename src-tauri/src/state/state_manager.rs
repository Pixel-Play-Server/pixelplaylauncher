...
use crate::state::pixelplay_packs_state::{default_pixelplay_packs_path, pixelplayPackManager};
use crate::state::pixelplay_versions_state::{default_pixelplay_versions_path, pixelplayVersionManager};
...
pub struct State {
    ...
    pub pixelplay_pack_manager: pixelplayPackManager,
    pub pixelplay_version_manager: pixelplayVersionManager,
    ...
    pub async fn init(app: Arc<tauri::AppHandle>) -> Result<()> {
        let initial_state_arc = LAUNCHER_STATE
            .get_or_try_init(|| async {
                ...
                let pixelplay_pack_manager = pixelplayPackManager::new(default_pixelplay_packs_path())?;
                let pixelplay_version_manager = pixelplayVersionManager::new(default_pixelplay_versions_path())?;
        ...
        initial_state_arc
            ...
            .on_state_ready(app.clone())
            .await?;
        log::info!("State::init - pixelplayVersionManager post-initialization complete.");

        initial_state_arc
            .pixelplay_pack_manager
            .on_state_ready(app.clone())
            .await?;
        log::info!("State::init - pixelplayPackManager post-initialization complete.");
