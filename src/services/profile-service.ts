...
import { pixelplayVersionsConfig } from "../types/pixelplayVersions";
...
export async function setpixelplayModStatus(
  profileId: string,
  packId: string,
  modId: string,
  gameVersion: string,
  ...
  return invoke<void>("set_pixelplay_mod_status", {
    profileId,
    packId,
    modId,
    gameVersion,
...
export async function getpixelplayPacks(): Promise<any> {
  return invoke<any>("get_pixelplay_packs");
}

export async function getpixelplayPacksResolved(): Promise<any> {
  return invoke<any>("get_pixelplay_packs_resolved");
}

export async function getStandardProfiles(): Promise<pixelplayVersionsConfig> {
  return invoke<pixelplayVersionsConfig>("get_standard_profiles");
}

export async function refreshpixelplayPacks(): Promise<void> {
  return invoke<void>("refresh_pixelplay_packs");
}
