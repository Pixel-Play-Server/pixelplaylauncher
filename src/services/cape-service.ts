...
import type { CapesBrowseResponse, BrowseCapesOptions, GetPlayerCapesPayloadOptions, CosmeticCape } from '../types/pixelplayCapes';
 ...
 * @param pixelplayToken Optional pixelplay token
...
export const addFavoriteCape = (
  ...
  return invoke('add_favorite_cape', { capeHash, pixelplayToken });
};
...
export const removeFavoriteCape = (
  ...
  return invoke('remove_favorite_cape', { capeHash, pixelplayToken });
};
...
export const setCapeFavorite = async (
  ...
  if (favorite) {
    return addFavoriteCape(capeHash, pixelplayToken);
  }
  return removeFavoriteCape(capeHash, pixelplayToken);
};
...
export const toggleCapeFavorite = async (
  ...
  return setCapeFavorite(capeHash, !isCurrentlyFavorite, pixelplayToken);
}; 
...
export const getCapesByHashes = (
  ...
  return invoke('get_capes_by_hashes', { hashes, pixelplayToken });
}; 