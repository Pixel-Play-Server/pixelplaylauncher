...
import type { CosmeticCape } from "../../types/pixelplayCapes";
...
function CapeItemDisplay({
  ...
  // Only use favorites for pixelplay capes
  ...
  return (
    ...
    >
      ...
      <div className={`absolute top-3 right-3 z-20 flex flex-col gap-1`}>
        {/* Favorite button (only for pixelplay capes) */}
        {!isVanilla && (
          <button
            onClick={(e) => {
              e.preventDefault();
      ...
      <div className="flex flex-col items-center gap-3 relative z-10 w-full">
        ...
        <div className="flex-grow min-w-0 w-full text-center">
          ...
          {/* Usage Stats (only for pixelplay capes) */}
          {!isVanilla && (
