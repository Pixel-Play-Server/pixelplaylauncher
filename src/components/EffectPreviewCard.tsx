...
import { OGBallsEffect } from "./effects/OGBallsEffect";
import { OGBothEffect } from "./effects/OGBothEffect";
...
export default function EffectPreviewCard({
  ...
  const renderEffect = () => {
    ...
    switch (effectId) {
      ...
      case BACKGROUND_EFFECTS.OG_BALLS:
        return <OGBallsEffect opacity={qualityParams.opacity} speed={qualityParams.speed * 0.9} {...previewProps} />;
      case BACKGROUND_EFFECTS.OG_BOTH:
        return <OGBothEffect opacity={qualityParams.opacity} speed={qualityParams.speed * 0.9} {...previewProps} />;
      default:
        return null;
    }
  };
