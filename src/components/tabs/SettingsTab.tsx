...
export function SettingsTab() {
  ...
  const backgroundOptions = [
    {
      ...
      name: t("backgroundEffects.matrixRain"),
      icon: "solar:code-bold",
    },
    {
      id: BACKGROUND_EFFECTS.ENCHANTMENT_PARTICLES,
      name: t("backgroundEffects.enchantmentTable"),
      icon: "solar:magic-stick-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_WAVES,
      name: t("backgroundEffects.nebulaWaves"),
      icon: "solar:soundwave-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_PARTICLES,
      name: t("backgroundEffects.nebulaParticles"),
      icon: "solar:star-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_GRID,
      name: t("backgroundEffects.nebulaGrid"),
      icon: "solar:widget-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_VOXELS,
      name: t("backgroundEffects.nebulaVoxels"),
      icon: "solar:asteroid-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_LIGHTNING,
      name: t("backgroundEffects.nebulaLightning"),
      icon: "solar:bolt-bold",
    },
    {
      id: BACKGROUND_EFFECTS.NEBULA_LIQUID_CHROME,
      name: t("backgroundEffects.liquidChrome"),
      icon: "solar:cloud-waterdrops-bold",
    },
    {
      id: BACKGROUND_EFFECTS.RETRO_GRID,
      name: t("backgroundEffects.retroGrid"),
      icon: "solar:widget-5-bold",
    },
    {
      id: BACKGROUND_EFFECTS.PLAIN_BACKGROUND,
      name: t("backgroundEffects.plainColor"),
      icon: "solar:palette-bold",
    },
    {
      id: BACKGROUND_EFFECTS.OG_BALLS,
      name: t("backgroundEffects.og"),
      icon: "solar:circle-bold",
    },
    {
      id: BACKGROUND_EFFECTS.OG_BOTH,
      name: t("backgroundEffects.ogBoth"),
      icon: "solar:circle-2-bold",
    },
  ];
  ...
  const qualityOptions: { value: QualityLevel; label: string; icon: string }[] =
    [
      ...
      { value: "high", label: t("settings.high"), icon: "solar:battery-charge-bold" },
    ];
  ...
  const autoSaveConfig = useCallback(async (configToSave: LauncherConfig) => {
    ...
    autoSaveTimeoutRef.current = setTimeout(async () => {
      ...
      try {
        ...
        toast.success(t("settings.settingsAutoSaved"), {
          duration: 2000,
        ...
        toast.error(t("errors.autoSaveFailed", { error: errorMessage }));
      } finally {
        setSaving(false);
      }
    }, 500);
  ...
  const handleCustomColorSubmit = () => {
    ...
    if (isValidHex) {
      setCustomAccentColor(customColor);
        toast.success(t("settings.customColorApplied"));
    } else {
      toast.error(t("settings.invalidHexColor"));
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          <Icon icon="solar:translation-bold" className="w-6 h-6 text-white" />
          <h3 className="text-3xl font-minecraft text-white">
            {t("settings.language")}
          </h3>
        </div>
        <p className="text-base text-white/70 font-minecraft-ten mt-2">
          Select your preferred language for the launcher interface (BETA)
        </p>
        <div className="mt-4">
          <LanguageSelector className="w-full md:w-64 h-[42px]" />
        </div>
      </div>
      ...
      <div className="mt-6 flex items-center gap-6">
        ...
        <button
          ...
          title={t("tooltips.customColorPicker")}
        >
          <div
        ...
        settings={[
          {
            ...
            tooltip: t("tooltips.autoUpdates"),
            type: "toggle",
          ...
          },
          {
            ...
            tooltip: t("tooltips.discordPresence"),
            type: "toggle",
          ...
          },
          {
            ...
            tooltip: t("tooltips.betaUpdates"),
            type: "toggle",
          ...
          ...(canShowExperimental ? [{
            ...
            label: t("settings.experimentalMode"),
            tooltip: t("tooltips.experimentalMode"),
          ...
          {
            id: "open-logs",
            label: t("settings.openLogsAfterStarting"),
            tooltip: t("tooltips.openLogsAfterStarting"),
            type: "toggle",
          ...
          {
            id: "hide-window",
            label: t("settings.hideWindowOnLaunch"),
            tooltip: t("tooltips.hideWindowOnLaunch"),
            type: "toggle",
        ...
        settings={[
          {
            ...
            tooltip: t("tooltips.concurrentDownloads"),
            type: "range",
          ...
          {
            id: "concurrent-io",
            label: t("settings.concurrentIO"),
            tooltip: t("tooltips.concurrentIO"),
            type: "range",
          ...
          },
          {
            ...
            tooltip: t("tooltips.borderRadius"),
            type: "range",
            value: borderRadius,
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex flex-col items-end gap-2" style={{ transform: 'translateY(16px)' }}>
              <div className="flex items-center gap-2">
                <span className="text-sm text-white/70 font-minecraft-ten">{t("settings.animations")}</span>
                <ToggleSwitch
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs text-white/60 font-minecraft-ten">{t("settings.quality")}: {t("settings.low")}</span>
                <input
                  type="range"
                  min="0"
                  max="2"
                  ...
                  disabled={saving}
                />
                <span className="text-xs text-white/60 font-minecraft-ten">{t("settings.high")}</span>
              </div>
            </div>
          </div>
          <p className="text-base text-white/70 font-minecraft-ten mt-2">
        ...
        {isHooksExpanded && (
          <div className="space-y-6 mt-6">
            ...
            <div className="mt-6 p-4 rounded-lg border border-[#ffffff20] bg-black/10">
              <div className="flex items-start gap-3">
                <Icon icon="solar:info-circle-bold" className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="text-xl font-minecraft text-emerald-300 mb-2 lowercase">
                    Examples
                  </h4>
                  <div className="space-y-2 text-sm text-emerald-200/80 font-minecraft-ten">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <Button
              ...
              size="sm"
              onClick={() => {
                openExternalUrl("https://pixelplay.gg/licenses")
              }}
