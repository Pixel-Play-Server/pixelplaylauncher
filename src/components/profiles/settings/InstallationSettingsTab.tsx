...
export function InstallationSettingsTab({
  ...
  }, [editedProfile.id, editedProfile.game_version, editedProfile.loader, editedProfile.loader_version, editedProfile.settings.use_overwrite_loader_version, editedProfile.settings.overwrite_loader_version, editedProfile.selected_pixelplay_pack_id]);
  ...
  const getReasonText = (reason: string): string => {
    switch (reason) {
      case "pixelplay_pack":
        return "Forced by pixelplay Pack";
      case "user_overwrite":
