...
export function ProfileWizardV2({ onClose, onSave, defaultGroup }: ProfileWizardV2Props) {
  ...
  const handleStep3Create = async (profileData: {
    ...
    const createParams: CreateProfileParams = {
      ...
      selected_pixelplay_pack_id: profileData.selectedpixelplayPackId || undefined,
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex gap-2">
            {[
              { key: "release", label: t("common.version"), icon: "solar:star-bold" },
        ...
        {filteredVersions.length === 0 && !loading && (
          <div className="col-span-3 text-center py-8">
            ...
            <p className="text-lg font-minecraft text-white/70 lowercase">{t("search.noResults")}</p>
          </div>
        )}
      </div>
    );
