...
type MainTabType = "content" | "browse" | "worlds" | "logs" | "screenshots" | "modsv2" | "resourcepacksv2" | "pixelplayv2" | "datapacksv2" | "shaderpacksv2";
type ContentSubType =
  | "modsv2"
  | "resourcepacksv2"
  | "shaderpacksv2"
...
export function ProfileDetailView({
  ...
  const contentSubTabs = [
    ...
    {
      id: "pixelplayv2" as ContentSubType,
      label: "pixelplay Mods",
