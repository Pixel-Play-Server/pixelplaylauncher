  ...
  const handleSave = async () => {
    try {
      ...
      await updateProfile(profile.id, {
        ...
        selected_pixelplay_pack_id: editedProfile.selected_pixelplay_pack_id,
        clear_selected_pixelplay_pack: !editedProfile.selected_pixelplay_pack_id,
        group: editedProfile.group,
        clear_group: !editedProfile.group,
        description: editedProfile.description,
        pixelplay_information: editedProfile.pixelplay_information,
