        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between p-4 rounded-lg bg-black/20 border-2 border-white/20 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <IconButton
                ...
                onClick={() => handleOpenUrl("https://joacoorandom.pixelplay.gg")}
                variant="default"
                size="sm"
                title="Visit joacoorandom.pixelplay.gg"
              />
            </div>
          </div>
            <div className="flex items-center justify-between p-4 rounded-lg bg-black/20 border-2 border-white/20 transition-colors">
          ...
          <div className="flex justify-center pt-4">
            <Button
              ...
              onClick={() => handleOpenUrl("https://discord.pixelplay.gg")}
            >
              <Icon icon="solar:external-link-bold" className="w-5 h-5" />
              <span className="font-minecraft text-lg lowercase">Join Discord</span>
            </Button>
          </div>
        </div>
      </div>
