import { pixelplayModIdentifier, type LocalContentItem as ProfileLocalContentItem } from "./profile";
...
export interface ToggleContentPayload {
  ...
  pixelplay_mod_identifier?: pixelplayModIdentifier; // Optional identifier for pixelplay Pack items
...
// Represents a pixelplayMod item as expected by the backend for add/remove operations