...
export interface pixelplayModIdentifier {
  pack_id: string;
  mod_id: string;
  game_version: string;
  loader: ModLoader;
...
export interface pixelplayInformation {
...
export interface Profile {
  ...
  state: ProfileState;
  mods: Mod[];
  selected_pixelplay_pack_id: string | null;
  disabled_pixelplay_mods_detailed: pixelplayModIdentifier[];
  ...
  pixelplay_information: pixelplayInformation | null;
...
export interface CreateProfileParams {
  ...
  selected_pixelplay_pack_id?: string;
  use_shared_minecraft_folder?: boolean;
}
...
export interface UpdateProfileParams {
  ...
  use_shared_minecraft_folder?: boolean;
  description?: string | null;
  clear_selected_pixelplay_pack?: boolean;
  banner?: ProfileBanner | null;
  background?: ProfileBanner | null;
  pixelplay_information?: pixelplayInformation | null;
}
...
/**
 * Details about an item when it comes from a pixelplay Pack
 */
export interface pixelplayPackItemDetails {
  is_enabled: boolean;
  pixelplay_mod_identifier?: pixelplayModIdentifier;
}

export interface ContentInstallStatus {
  is_included_in_pixelplay_pack: boolean;
  is_installed: boolean;
  is_specific_version_in_pack: boolean;
  is_enabled?: boolean;
  found_item_details?: FoundItemDetails;
  pixelplay_pack_item_details?: pixelplayPackItemDetails;
}
...
export interface LocalContentItem {
  ...
  pixelplay_info?: pixelplayModIdentifier | null; // Identifier for pixelplayMods
