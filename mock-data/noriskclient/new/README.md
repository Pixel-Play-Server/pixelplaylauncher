...
│   ├── config/
│   │   └── hi.json       # Beispiel: pixelplayClient Konfiguration
│   └── mods/
│       └── example.jar   # Beispiel: Standard-Mods
└── [andere pixelplayClient Dateien...]
```
...
- **Quelle**: `{default_profile_path}/pixelplayclient/new/{relative_path}`
- **Ziel**: `{profile_dir}/{relative_path}`

Beispiel:
- Quelle: `~/Library/Application Support/gg/pixelplay/pixelplayClientV3/profiles/pixelplayclient/new/options.txt`
- Ziel: `~/Library/Application Support/gg/pixelplay/pixelplayClientV3/profiles/{profile-id}/options.txt`
